...
impl Line {
    ...
    // Returns:
    // A Vec of (byte_index, grapheme_idx) pairs for each match that aligns with the grapheme clusters, where byte_index is the byte index of the match, and grapheme_idx is the grapheme index of the match.
